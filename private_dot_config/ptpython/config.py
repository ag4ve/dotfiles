...
From: https://raw.githubusercontent.com/prompt-toolkit/ptpython/master/examples/ptpython_config/config.py
...
def configure(repl):
    ...
    # TODO create some type of invpaste function
    ...
    # vim, fruity, native also looked ok
    ...
    # Import modules from CWD
    @repl.add_key_binding(Keys.ControlN, Keys.ControlN)
    def _(event):
        code = 'import sys; sys.path.append("%s");' % PROJECT_DIR
